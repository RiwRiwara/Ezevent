...
'primary' => " relative inline-flex items-center justify-center p-0.5  overflow-hidden md:text-md leading-9 w-full md:w-auto
...
'secondary' => " relative inline-flex items-center justify-center p-0.5  overflow-hidden md:text-md leading-9 w-full md:w-auto
...
'danger' => " relative inline-flex items-center justify-center p-0.5  overflow-hidden md:text-md leading-9 w-full md:w-auto
...
'success' => " relative inline-flex items-center justify-center p-0.5  overflow-hidden md:text-md leading-9 w-full md:w-auto
