            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td>
                    ...
                    <div id="form_modal_{{$application['application_id']}}" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 items-center justify-center hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                        <div class="relative w-full max-w-3xl max-h-full {{$application['type'] == 'Participant' ? 'bg-neutral-2' : 'bg-primary-2' }} p-4 rounded-md">
                            <!-- Modal content -->
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                                    <div class="flex flex-col gap-2">
                                        ...
                                        <h3 class="text-xs font-semibold text-gray-500 dark:text-white">
                                            User ID : {{$application['user']['user_id']}}
                                        </h3>
                                        <a 
                                        target="_blank"
                                        href="{{
                                            route('participant-profile', ['user_id' => $application['user']['user_id']])
