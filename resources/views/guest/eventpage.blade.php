<x-app-layout>
    ...
    <!-- ใส่ Nav Bar ตรงเน้ -->
    <h3 class="text-2xl px-20 text-left text-gray-9 mx-20">{{__('page.overview')}}</h3>
    <div class="container px-10 mx-auto pt-8 grid gap-20 grid-cols-2">
        ...
        <div class="border border-neutral-9 px-10 py-5">
            ...
            <div class="mt-5 flex justify-center">
                <button type="submit" class="block w-80 border border-neutral-8 rounded-md bg-white text-center text-xl text-neutral-8 shadow-sm hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">{{__('page.save_phase')}}</button>
            </div>
            <div class="mt-5 flex justify-center">
                <button type="submit" class="block w-80 border border-neutral-8 rounded-md bg-white px-3.5 py-2.5 text-center text-2xl text-neutral-8 shadow-sm hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">{{__('page.create_qr')}}</button>
            </div>
        </div>
    </div>
