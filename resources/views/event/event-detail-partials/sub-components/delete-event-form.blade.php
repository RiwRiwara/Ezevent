            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 space-y-4">
                    <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                        if you delete this event, it will be permanently deleted and cannot be recovered.
                    </p>
                    <p>
                        Are you sure you want to delete. Please type " <span class="font-bold text-neutral-9">
                            {{ $event->event_name }}
                        </span> " and click delete button.
                    </p>

                    <x-forms.input-outline-primary name="confirm_name" label="{{__('Enter Event name')}}" type="text" required />
