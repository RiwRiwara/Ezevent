...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('/event/saveevent/{event_id}',[MyEventApiController::class, 'saveEvent'])->name('api.myevent.save_event');
    Route::get('/event/getsavedevent',[MyEventApiController::class, 'getSavedEvent'])->name('api.myevent.get_saved_event');
