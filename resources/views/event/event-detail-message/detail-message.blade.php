<div class="max-w-7xl mx-auto sm:px-4 lg:px-8">
    ...
    {{__("event.menu-event.menu-event8")}}
    </h1>
    ...
    <div class="flex flex-col gap-4">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4">
                ...
                <label for="table-search-message" class="sr-only">Search</label>
                <div class="relative">
                    ...
                    <input type="text" id="table-search-message" class="block p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for items">
                </div>
            </div>
