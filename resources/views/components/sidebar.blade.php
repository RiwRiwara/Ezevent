...
<aside id="default-sidebar"
   ...
   <div class="min-h-screen bg-gray-100">
      <div class="sidebar min-h-screen w-[3.35rem] overflow-hidden border-r bg-neutral-7 hover:w-56 hover:shadow-lg">
               ...
               <ul class="space-y-4 font-medium ">
                  ...
                  <li class="min-w-max">
                     <a href="#" class="group flex items-center space-x-4 rounded-md px-4 py-3 text-white">
                        ...
                        <span class="group-hover:text-gray-700">CRM</span>
                     </a>
                  </li>
                  <li class="min-w-max">
                     <a href="#" class="group flex items-center space-x-4 rounded-md px-4 py-3 text-white">
