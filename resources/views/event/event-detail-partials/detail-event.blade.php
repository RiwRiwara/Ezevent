<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
    <form action="" id="update-form" method="POST" class="container px-10 mx-auto pt-8">
        @csrf
...
<script>
    var createForm = document.getElementById('update-form');
    ...
    createForm.addEventListener('submit', function(event) {
        event.preventDefault();
        Swal.fire({
            title: "Are you sure to update event detail?",
