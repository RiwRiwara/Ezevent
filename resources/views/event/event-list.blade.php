<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto p-6 md:p-8 my-5 md:mt-10 bg-white rounded-md h-fit ">
        <div class="md:flex-col gap-4">
            ...
            @if ($page_data['isHaveActiveEvent'] == false)
            ...
            <div class="mt-10 flex flex-col items-center justify-center gap-4b ">
                ...
                <label class="text-xl font-bold text-neutral-8 my-2">{{__('Event not founded')}}</label>
                <a href="{{route('event-list')}}" class="p-1 text-sm font-medium text-white bg-neutral-8 rounded-lg border border-neutral-7 hover:bg-neutral-8 focus:ring-4 focus:outline-none focus:ring-neutral-3 dark:bg-neutral-6 dark:hover:bg-neutral-7 dark:focus:ring-neutral-8 duration-300">
                    Clear Search
                </a>
