...
<div class="flex" style="font-family: IBM Plex Sans Thai">
        <aside class="flex h-screen w-20 flex-col items-center border-r border-gray-200 bg-neutral-7">
            ...
            <nav class="flex flex-1 flex-col gap-y-4 pt-4">
                <a href="#" class="text-white group relative rounded-xl p-2 hover:bg-gray-50 bg-neutral-8">
                ...
                <a href="#" class="text-white group relative rounded-xl p-2 hover:bg-gray-50">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
